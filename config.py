...
SQL_HOSTNAME = '<host_ip or hostname>'  # host server ip or hostname
...
DATABASE_URI = f"mysql+pymysql://{SQL_USERNAME}:{get_secret(GCP_PROJECT_NO, SQL_PASSWORD_SECRET_ID)}@{SQL_HOSTNAME}/{SQL_DB_NAME}"
